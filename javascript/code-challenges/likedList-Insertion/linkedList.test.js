...
describe('LinkedList', () => {
  ...
  it('should throw an error when inserting before a non-existent value', () => {
    ...
    expect(() => linkedList.insertBefore(4, 5)).toThrowError('Node not found in the list.');
  });
  ...
  it('should throw an error when inserting after a value in an empty list', () => {
    expect(() => linkedList.insertAfter(1, 5)).toThrowError('The list is empty.');
  });
  ...
  it('should throw an error when inserting after a non-existent value', () => {
    ...
    expect(() => linkedList.insertAfter(4, 5)).toThrowError('Value not found in the list.');
  });
});
